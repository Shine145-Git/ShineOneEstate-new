...
export default function LoginModal() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_LOGIN_REQUEST_OTP_API}`,
        {
          method: "POST",
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_LOGIN_VERIFY_OTP_API}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  // Show full-page spinner while loading after email submit, before OTP form
