    ...
    recognition.onresult = async (event) => {
      ...
      try {
        ...
        if (
          ...
          console.log(
            "⚠️ Ignoring repeated or similar input:",
            userSpeech,
            "| similarity:",
            ratio.toFixed(2)
          );
        ...
        if (nextIdx === questions.length - 1) {
          ...
          try {
            ...
            if (resp.ok) {
              ...
              if (result.success) {
                console.log("✅ Preferences saved successfully in DB!");
              } else {
                console.warn(
                  "⚠️ Preferences may not have been saved properly:",
                  result
                );
              }
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {listening ? "🎙️ LISTENING" : "⏸️ STANDBY"}
                    </span>
                  </div>
                  <div
                    style={{
